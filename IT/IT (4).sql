...
--
-- Host: localhost:3306
-- Generation Time: Dec 01, 2024 at 01:05 PM
...
(13, 'Miskas', 'left', 'https://www.startpage.com/av/proxy-image?piurl=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.7gKB4b_q3CIv1QikyVEXWwHaFj%26pid%3DApi&sp=1733050937T25595fd6815306ddcb5d62e9e7848c5a92e42369586a12e2897a57ebbc8d7915');
...
(10, 'Sveikas gyvenimas misko apsuptyje', '2024-12-01 13:02:43', 6, 9);
...
(24, 'gyventi miske yra smagu', 10, 13),
(25, 'antras blokas', 10, NULL);
...
(7, 'Geras miegas', 2),
(8, 'Knygos', 2),
(9, 'Sveikas gyvenimas misko apsuptyje', 5);
...
(4, 'antanas', '$2y$10$uEY6vkm8bmTBvlHJwTyRnOqdQRvga6vkbN0Wxh6vSUIyrt.aTWGDe', 'Antanas', 'Antanas', 1),
(5, 'administratorius', '$2y$10$WUQZx5pzQmp.Wpssm.mIgedGRZrLaMpt2laJOjor.VsqQd1oq7qFG', 'simas', 'admin', 3),
(6, 'rasytojas2', '$2y$10$ph05BP20vmma8.x6pyXveu7crRejZOYT4WsxyutBxxRicMmdMyBKe', 'simas', 'Rasytojas', 2),
(7, 'skaitytojas2', '$2y$10$tjNhdEOFcrvGBYKNsUC3lumLyjcn5TCE.Rdp8U1cwfnEHFGK1b/Ra', 'simas', 'Skaitytojas', 1);
...
(14, 6, '2024-12-01 13:04:34', 7, 10),
(15, 10, '2024-12-01 13:04:47', 7, 5);
